...
class Ui_StackedWidget(object):
    def setupUi(self, StackedWidget):
        ...
        self.horizontalLayout_4.setContentsMargins(350, -1, 350, -1)
        ...
        self.signing_up = QtWidgets.QPushButton(self.sign_up_page)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.signing_up.sizePolicy().hasHeightForWidth())
        self.signing_up.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Copperplate Gothic Bold")
        font.setPointSize(16)
        self.signing_up.setFont(font)
        self.signing_up.setStyleSheet("background-color: rgb(255, 163, 26);")
        self.signing_up.setObjectName("signing_up")
        self.horizontalLayout_12.addWidget(self.signing_up)
    ...
    def retranslateUi(self, StackedWidget):
        ...
        self.signing_up.setText(_translate("StackedWidget", "Sign Up"))
